...
export class V13Part4Sync1727131216466 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    `);
    await queryRunner.query(`
        ALTER TYPE IF EXISTS "public"."gamevault_user_role_enum"
        RENAME TO "gamevault_user_role_enum_old"
    `);
    await queryRunner.query(`
        CREATE TYPE IF NOT EXISTS "public"."v12_gamevault_user_role_enum" AS ENUM('0', '1', '2', '3')
    `);
    await queryRunner.query(`
        ALTER TABLE "v12_gamevault_user"
    ...
    `);
    await queryRunner.query(`
        CREATE INDEX IF NOT EXISTS "IDX_9104e2e6a962d5cc0b17c3705d" ON "v12_image" ("id")
    `);
    await queryRunner.query(`
        CREATE INDEX IF NOT EXISTS "IDX_fe74c6fdec37f411e4e042e1c7" ON "v12_image" ("path")
    `);
    await queryRunner.query(`
        CREATE INDEX IF NOT EXISTS "IDX_59b393e6f4ed2f9a57e15835a9" ON "v12_gamevault_user" ("id")
    `);
    await queryRunner.query(`
        CREATE INDEX IF NOT EXISTS "IDX_d8fa7fb9bde6aa79885c4eed33" ON "v12_gamevault_user" ("username")
    `);
    await queryRunner.query(`
        CREATE INDEX IF NOT EXISTS "IDX_d99731b484bc5fec1cfee9e0fc" ON "v12_game" ("id")
    `);
    await queryRunner.query(`
        CREATE INDEX IF NOT EXISTS "IDX_179bcdd73ab43366d14defc706" ON "v12_game" ("release_date")
    `);
    await queryRunner.query(`
        CREATE UNIQUE INDEX IF NOT EXISTS "IDX_95628db340ba8b2c1ed6add021" ON "v12_game" ("file_path")
    `);
    await queryRunner.query(`
        ALTER TABLE "v12_image"
        ADD CONSTRAINT IF NOT EXISTS "FK_2feca751bd268e1f80b094c7fff" FOREIGN KEY ("uploader_id") REFERENCES "v12_gamevault_user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION
    `);
    await queryRunner.query(`
        ALTER TABLE "v12_progress"
        ADD CONSTRAINT IF NOT EXISTS "FK_c20491fd4d90ac21f386d572013" FOREIGN KEY ("user_id") REFERENCES "v12_gamevault_user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION
    `);
    await queryRunner.query(`
        ALTER TABLE "v12_gamevault_user"
        ADD CONSTRAINT IF NOT EXISTS "FK_add8fb3363cdc1f4f5248797c1f" FOREIGN KEY ("profile_picture_id") REFERENCES "v12_image"("id") ON DELETE CASCADE ON UPDATE NO ACTION
    `);
    await queryRunner.query(`
        ALTER TABLE "v12_gamevault_user"
        ADD CONSTRAINT IF NOT EXISTS "FK_b67991f386cfd93877a8c42d134" FOREIGN KEY ("background_image_id") REFERENCES "v12_image"("id") ON DELETE CASCADE ON UPDATE NO ACTION
    `);
    await queryRunner.query(`
        ALTER TABLE "v12_game"
        ADD CONSTRAINT IF NOT EXISTS "FK_58972db9052aa0dbc1815defd6a" FOREIGN KEY ("background_image_id") REFERENCES "v12_image"("id") ON DELETE CASCADE ON UPDATE NO ACTION
    `);
    await queryRunner.query(`
        ALTER TABLE "v12_bookmark"
        ADD CONSTRAINT IF NOT EXISTS "FK_ba0312a26cea7e0d2e4f3a47b3f" FOREIGN KEY ("v12_gamevault_user_id") REFERENCES "v12_gamevault_user"("id") ON DELETE CASCADE ON UPDATE CASCADE
    `);
  }
