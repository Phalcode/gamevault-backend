...
export class NewIndexes1713526846245 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
        ...
        `);
    await queryRunner.query(`
            DROP INDEX "public"."IDX_289102542903593026bd16e4e1"
        `);
    await queryRunner.query(`
            DROP INDEX "public"."IDX_45c4541783f264043ec2a5864d"
        `);
    await queryRunner.query(`
            DROP INDEX "public"."IDX_4a0539222ee1307f657f875003"
        `);
    await queryRunner.query(`
            DROP INDEX "public"."IDX_672bce67ec8cb2d7755c158ad6"
        `);
    await queryRunner.query(`
            DROP INDEX "public"."IDX_5c0cd47a75116720223e43db85"
        `);
    await queryRunner.query(`
            DROP INDEX "public"."IDX_99bd20f783c41fe05489a0aca5"
        `);
  }
}
