...
export class GameMetadata extends DatabaseEntity {
  @Index()
  @ManyToOne(() => GamevaultGame, (game) => game.metadatas)
  @ApiPropertyOptional({
  ...
  @ApiPropertyOptional({
    description:
      "priority of usage of the metadata for this game, lowest will be used first",
    example: 1,
  })
  priority?: number;

  @ManyToOne(() => MetadataProvider, (provider) => provider.games)
  @ApiProperty({
